...
// linr
zen_coding['addHTMLSetting'] = function(name, value){
	zen_settings['html']['snippets'][name] = value;
}
zen_coding['addCSSSetting'] = function(name, value){
	zen_settings['css']['snippets'][name] = value;
}
